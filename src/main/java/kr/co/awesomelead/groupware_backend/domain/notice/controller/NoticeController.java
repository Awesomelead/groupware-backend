...
public class NoticeController {
    ...
    public ResponseEntity<ApiResponse<Long>> createNotice(
        @Parameter(description = "공지사항 생성 정보 (JSON)", required = true, schema = @Schema(implementation = NoticeCreateRequestDto.class))
    ...
    public ResponseEntity<ApiResponse<NoticeDetailDto>> getNotice(
        @Parameter(description = "조회할 공지사항 ID", example = "1", required = true)
    ...
    @ApiResponses(value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                @ExampleObject(name = "사용자 없음", value = "{\"isSuccess\": false, \"code\": \"USER_NOT_FOUND\", \"message\": \"해당 사용자를 찾을 수 없습니다.\" }"),
                @ExampleObject(name = "공지사항 없음", value = "{ \"isSuccess\": false, \"code\": \"NOTICE_NOT_FOUND\", \"message\": \"해당 공지사항을 찾을 수 없습니다.\" }"),
                @ExampleObject(name = "첨부파일 없음", value = "{ \"isSuccess\": false, \"code\": \"NOTICE_ATTACHMENT_NOT_FOUND\", \"message\": \"해당 공지사항 첨부파일을 찾을 수 없습니다.\" }")
            }))
    })
    ...
    public ResponseEntity<ApiResponse<Long>> updateNotice(
        ...
        @Parameter(description = "공지사항 수정 정보 (JSON)", required = true, schema = @Schema(implementation = NoticeUpdateRequestDto.class))
