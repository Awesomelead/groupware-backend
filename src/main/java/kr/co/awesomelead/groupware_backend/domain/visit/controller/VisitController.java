...
@Tag(
        ...
        description =
            ...
            - **VisitPurpose**: 방문 목적 (`CUSTOMER_INSPECTION`: 검수/현장작업, `LOGISTICS_AND_DELIVERY`: 입출고 및 물품 납품, `FACILITY_CONSTRUCTION`: 시설공사, `HAZARDOUS_SUBSTANCE`: 위험물질 반입, `MEETING`: 미팅, `OTHER`: 기타)
