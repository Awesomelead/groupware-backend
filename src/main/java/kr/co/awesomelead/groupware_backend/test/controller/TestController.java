...
public class TestController {
    ...
    @Operation(summary = "[테스트] 아이디 찾기 (전체 조회)",
        description = "성능 테스트용 - 인증 우회")
    @PostMapping("/find-email")
    public ResponseEntity<FindEmailResponseDto> testFindEmail(
        @Valid @RequestBody FindEmailRequestDto requestDto) {

        // 인증 체크 없음
        FindEmailResponseDto response = testService.findEmailByAll(
            requestDto.getName(),
    ...
    @Operation(summary = "[테스트] 아이디 찾기 (해시)",
        description = "성능 테스트용 - 인증 우회")
    ...
    public ResponseEntity<FindEmailResponseDto> testFindEmailByHash(
        ...
        // 인증 체크 없음
        FindEmailResponseDto response = testService.findEmailByHash(
            requestDto.getName(),
            requestDto.getPhoneNumber()
        );
    ...
    @Operation(summary = "[테스트] 테스트 user 더미데이터 생성",
        description = "선택한 수만큼 테스트 user 더미데이터를 생성합니다.")
