...
public class AdminController {
    ...
    @ApiResponses(value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(mediaType = "application/json", examples = {
                ...
                @ExampleObject(name = "부서 없음", value = "{\"isSuccess\": false, \"code\": \"DEPARTMENT_NOT_FOUND\", \"message\": \"해당 부서를 찾을 수 없습니다.\"}")
            }))
    })
    ...
    @Operation(
        ...
        description = "특정 사용자의 역할을 변경하고, 역할에 따른 기본 권한(Authority)을 자동으로 부여/회수합니다. (ADMIN, MASTER_ADMIN만 호출 가능)"
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
    ...
    public ResponseEntity<ApiResponse<String>> updateUserRole(
        ...
        @Parameter(description = "변경할 역할 (USER, ADMIN 등)", example = "ADMIN")
