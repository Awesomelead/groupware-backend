...
@Getter
@Builder
@Schema(description = "제증명 발급 신청 상세 응답")
public class RequestHistoryDetailResponseDto {
    ...
    @Schema(description = "신청자 직급", example = "사원")
    ...
    @Schema(description = "처리일", example = "2026-03-08", nullable = true)
    private LocalDate processedDate;

    public static RequestHistoryDetailResponseDto from(RequestHistory requestHistory) {
        return RequestHistoryDetailResponseDto.builder()
                .id(requestHistory.getId())
                .name(requestHistory.getName())
                ...
                .processedByName(
                        requestHistory.getProcessedBy() != null
                                ? requestHistory.getProcessedBy().getDisplayName()
                                : null)
