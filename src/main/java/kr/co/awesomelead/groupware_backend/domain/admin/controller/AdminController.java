...
public class AdminController {
    ...
    @GetMapping("/users")
    public ResponseEntity<ApiResponse<List<AdminUserSummaryResponseDto>>> getUsers(
        @Parameter(hidden = true) @AuthenticationPrincipal CustomUserDetails userDetails) {
        List<AdminUserSummaryResponseDto> result = adminService.getUsers(userDetails.getId());
