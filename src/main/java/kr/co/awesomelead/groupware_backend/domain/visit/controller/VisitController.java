...
public class VisitController {
    ...
    @Operation(summary = "사전 방문 접수", description = "내방객이 온라인으로 사전방문접수를 수행합니다. 서명 이미지(PNG)와 4자리 비밀번호가 필수입니다.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "현장 방문 접수", description = "내방객이 현장에서 방문접수를 수행합니다. 서명 이미지(PNG)가 필수이며, 비밀번호는 선택사항입니다.")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "201",
    ...
    @Operation(summary = "부서별 방문 정보 조회", description = "직원이 특정 부서 혹은 전체 내방객 정보 목록을 조회합니다. 경비 부서는 전체 조회 가능합니다.")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "조회 성공",
    ...
    @Operation(summary = "직원용 방문 상세 정보 조회", description = "직원이 내방객 정보에 대한 상세 정보를 조회합니다. 서명 이미지 URL이 포함됩니다.")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "조회 성공",
    ...
    @Operation(summary = "방문 처리", description = "사전 예약된 내방객이 현장에 도착하여 방문처리를 수행합니다. 방문 시작 시간이 현재 시각으로 갱신됩니다.")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
