...
public class NoticeController {
    ...
    @Operation(
            ...
            description =
                ...
                **필터링 원칙**:
                - 공지 생성 시점에 대상자(NoticeTarget)로 포함된 공지 또는 본인이 작성한 공지만 노출됩니다.
                - **ACCESS_NOTICE**: 공지 생성/수정/삭제 권한입니다.
                - **VIEW_ALL_NOTICE**: 대상자가 아니어도 모든 공지를 조회할 수 있습니다.
                            ...
                            content = {
                                @Content(
                                        ...
                                        schema =
                                                @Schema(
                                                        implementation =
                                                                NoticeUpdateMultipartRequestDoc
                                                                        .class),
                                        encoding = {
                                            @Encoding(
                                                    name = "notice",
